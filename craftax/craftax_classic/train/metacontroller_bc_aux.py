    ...
    def train_some_episodes(
        ...
        def rollout_step(carry, step):
            ...
            return (
                ...
                next_lstm_states,
                rng,
            ), (init_obs, next_obs, init_done, value, action, logprob, reward)
        ...
        (
            ...
            (obs, future_obs, dones, values, actions, logprobs, rewards),
        ) = jax.lax.scan(
            rollout_step,
            (
                next_obs,
        ...
        def ppo_loss(
            ...
            pred_other_player = predicted_future_obs.reshape(mb_future_obs[1].shape)
